...
from osp.namespaces import owl
...
from osp.tools.search import find
from osp.utils.datatypes import UID
    ...
    *elements: Union[
    ...
    Args:
        ...
        rel: When not `None` and when plotting an ontology individual, calls
            ...
            `osp.tools.search` to additionally plot such individuals.
    """
