...
from osp.ontology.utils import DataStructureSet, compatible_classes
from osp.utils import simphony_namespace
from osp.utils.cache import lru_cache_weak
from osp.utils.datatypes import (
    UID,
    AnnotationValue,
    AttributeValue,
    RelationshipValue,
...
if TYPE_CHECKING:
    from osp.interfaces.interface import Interface, InterfaceDriver
...
class Session(Environment):
    ...
    def compute(self, **kwargs) -> None:
        ...
        from osp.interfaces.remote.client import RemoteStoreClient
...
# This default ontology is later overwritten by osp/utils/pico.py
