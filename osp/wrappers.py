...
.html#advertising-behavior) `osp.wrappers`. This module loads all
...
from osp.interfaces.interface import Interface
from osp.session.wrapper import WrapperSpawner as Wrapper
...
if sys.version_info >= (3, 10) or sys.version_info < (3, 8):
    wrappers = package_entry_points.select(group="osp.wrappers")
else:
    wrappers = package_entry_points.get("osp.wrappers", tuple())
