...
from osp.utils.cache import lru_cache_timestamp
from osp.utils.datatypes import UID, Triple
from urllib.parse import urlparse

if TYPE_CHECKING:
    from osp.ontology.namespace import OntologyNamespace
    from osp.ontology.operations.container import Container
...
class OntologyEntity(ABC):
    ...
    def __init__(
        ...
        if session is None:
            from osp.ontology.operations.container import (
                ContainerEnvironment,
            )
            from osp.session.session import Environment, Session
